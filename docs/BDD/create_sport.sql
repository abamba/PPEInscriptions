...
CREATE TABLE COMPETITION(
        ...
        dateCloture_compet Date NOT NULL ,
...
# Table: CANDIDAT         stocke les equipes et les personnes

CREATE TABLE CANDIDAT(
        id_candidat  int (11) Auto_increment  NOT NULL ,
        nom_candidat Varchar (25) NOT NULL ,
        sub         Varchar (1) NOT NULL , #pour diff equipe et candidat
        prenom       Varchar (25) ,
        mail         Varchar (25) ,
...
CREATE TABLE COMPOSER(
        ...
        id_candidat_PERSONNE Int NOT NULL ,
