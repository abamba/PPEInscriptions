...
public class menu extends JFrame {
	...
	public void menuInsc(JTabbedPane tabbedPane)
	{
		...
		MenuCreateComp(panInscIntérieur);
		// Créer un candidat
		MenuCreateCand(panInscIntérieur);
		// Créer une équipe
		MenuCreateEq(panInscIntérieur);
		// Afficher les Compétitions
		MenuAffComp(panInscIntérieur);
		// Afficher les Candidats
		MenuAffCand(panInscIntérieur);
		// Afficher les équipe
		MenuAffEq(panInscIntérieur);
	...
	public void menuComp(JTabbedPane tabbedPane)
	{
		...
		MenuListeCandInscrits(panCompIntérieur);
		// Inscrire un candidat
		MenuInscrireCandidatComp(panCompIntérieur);
		// Désinscrire un candidat
		MenuDesinscCandidatComp(panCompIntérieur);
		// Modifier une compétition
		MenuModComp(panCompIntérieur);
		// Supprimer une compétition
		MenuSuppComp(panCompIntérieur);
